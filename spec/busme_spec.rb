...
describe 'Bus Me Application' do
  ...
  describe "#route_et" do
    it "should return no bus stop found" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=10000").
    ...
    it "should return no arrivals for scope" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=15414").
    ...
    it "should return the time for the one arrival" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=10656").
    ...
    it "should return the time for the next arrival" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=10246").
    ...
    it "should return the time for multiple arrivals on same route" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=19444").
    ...
    it "should rescue from an error" do
      stub_request(:get, "http://apps.santaclaritatransit.com/rtt/public/utility/file.aspx?contenttype=SQLXML&Name=RoutePositionET.xml&platformno=abc").
